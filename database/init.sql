...
INSERT INTO contents (course_id, seq, french, english) VALUES
(8, 1, 'Bonjour mademoiselle, est-ce que votre père est à la maison ?', 'Good morning (Good-day), miss. Is your father at home (Is it that your father is at the house)?'),
...
(8, 7, 'Attendez un moment, je cherche mon carnet d''adresses.', 'Wait a moment, I [am] looking for my address book.'),
...
(9, 1, 'Ce monsieur s''appelle Jérôme Laforge et cette dame est sa femme.', 'This gentlemen is called (calls-himself) Jérôme Laforge and this lady is his wife.'),
...
(9, 3, 'Quel âge a cet enfant?', 'How old is (what age has) this child?'),
(9, 4, 'Il a huit ans, monsieur.', 'He is (has) eight years [old], sir.'),
...
(9, 7, 'Bien. Et il habite chez vous ?', 'Fine. And he lives with (at) you?'),
...
(10, 8, 'Très bien. Alors je vous fais la carte. Voilà.', 'Very well. So I''ll do (am-doing) you the card. Here it is.'),
(10, 9, 'Réglez à la caisse, s''il vous plaît.', 'Pay at the cash desk, please.'),
(10, 10, 'Zut! Je ne trouve pas mon portefeuille!', 'Damn! I can''t find (not find not) my wallet!'),

(11, 1, 'Pourquoi allons-nous au marché ? Il est trop cher.', 'Why are we going (go we) to the market? It''s too expensive.'),
(11, 2, 'Parce que tous les placards sont vides!', 'Because all the cupboards are empty.'),
(11, 3, 'Nous avons besoin de tout: de fruits et de légumes,', 'We (have) need (of) everything: (of) fruit, (of) vegetables,'),
(11, 4, 'mais aussi de pain, de fromage, de beurre, de crème, de jambon, et...', 'but also (of) bread, (of) butter, (0) cream and...'),
...
(11, 7, 'Je vais acheter une livre de cerises, un kilo de pommes,', 'I am going (go) to buy a pound of cherries, a kilo of apples,'),
(11, 8, 'trois cents grammes de champignons, s''ils ne sont pas trop chers,', '300 grams of mushrooms, if they''re not too expensive,'),
(11, 9, 'quelques bananes, deux kilos de pommes de terre et un peu de lait frais.', 'a few bananas, two kilos of potatoes (apples of earth) and a little fresh milk.'),

(12, 1, 'Et avec ceci ? Vous voulez des fraises, peut-être ?', 'And with that? [Do] you want some strawberries, perhaps?'),
(12, 2, 'Est-ce que je peux les goûter ?', 'Can I taste them (Is it that I can then taste)?'),
(12, 3, 'Allez-y. N''hésitez pas! Toutes mes fraises sont bio.', 'Go ahead (go-there). Don''t hesitate. All my strawberries are organic.'),
(12, 4, 'Mm, c''est vrai, elles sont vraiment délicieuses. Elles sont à combien ?', 'Mm, it''s true, they''re really (truly) delicious. How much are they?'),
(12, 5, 'Le prix ? Elles ne sont pas chères. Seulement quinze euros le kilo.', 'The price? They''re not expensive. Only 15 euros a (the) kilo.'),
(12, 6, 'Non, c''est trop cher. J''ai tout ce que je veux pour l''instant.', 'No, it''s too expensive. I have all (everything it that I want for the time being (the instant).'),
...
(13, 2, 'Qu''est-ce que c''est ?', 'What is it (what is that it is)?'),
...
(13, 6, 'Vous pouvez envoyer des messages, commander un repas,', 'You can send messages, order a meal,'),
...
(13, 9, 'Est-ce que je peux l''essayer ?', 'Can I try it (Is it that I can it-try)?'),
(13, 10, 'Non, malheureusement. Ce n''est pas possible.', 'No, unfortunately. It''s not possible.'),
(13, 11, 'Il ne marche pas ?', 'Isn''t it working? (It doesn''t walk)'),
(13, 12, 'Je ne connais pas le code secret.', 'I don''t know the (secret) [pass]code.');
